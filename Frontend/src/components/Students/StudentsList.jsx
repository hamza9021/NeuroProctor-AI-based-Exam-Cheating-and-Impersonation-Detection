...
import { Search, ChevronUp, ChevronDown, Eye, Trash2, MoreVertical, Users, CheckCircle, AlertTriangle } from "lucide-react";
...
export default function StudentsList() {
    ...
    const embeddedCount = students.filter(student => 
        student.face_embeddings?.every(face => face.quality_score > 0)
    ).length;
    const pendingCount = total - embeddedCount;
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h2 className="text-xl font-semibold text-neutral-900">Students</h2>
                ...
                <Card padding="md">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-2xl font-semibold text-neutral-900 mt-1">{embeddedCount}</p>
                        </div>
                ...
                <Card padding="md">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-2xl font-semibold text-neutral-900 mt-1">{pendingCount}</p>
                        </div>
            ...
            {total > 0 && (
                <Card padding="md">
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            <h3 className="text-sm font-semibold text-neutral-900">Face Embedding Progress</h3>
                            <span className="text-sm text-neutral-500">
                                {Math.round((embeddedCount / total) * 100)}% Complete
                            </span>
                        </div>
                        <div className="w-full h-4 bg-neutral-200 rounded-full overflow-hidden">
                            <div 
                                className="h-full bg-green-500 rounded-full transition-all duration-500"
                                style={{ width: `${(embeddedCount / total) * 100}%` }}
                            />
                        </div>
                        <div className="flex items-center justify-between text-xs text-neutral-500">
                            <div className="flex items-center gap-2">
                                <div className="w-3 h-3 bg-green-500 rounded-full" />
                                <span>Embedded ({embeddedCount})</span>
                            </div>
                            <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <p className="text-sm text-neutral-600">
                    ...
                    <span className="font-medium text-neutral-900">
                        {students.length === 0 ? 0 : (page - 1) * limit + 1}
                    </span>
                    {" to "}
                    <span className="font-medium text-neutral-900">
