"""
NeuroProctor AI Services — Application Entry Point.
...
Startup sequence (order matters):
  ...
  d. Output directories — create AI-specific output folders.
...
async def lifespan(app: FastAPI) -> AsyncGenerator[None, None]:
    ...
    # ── STARTUP ──────────────────────────────────────────────────────────────
    logger.info("═" * 60)
    logger.info("  NeuroProctor AI Services — Starting up")
    ...
    # ── SHUTDOWN ─────────────────────────────────────────────────────────────
    logger.info("Shutting down NeuroProctor AI Services …")
